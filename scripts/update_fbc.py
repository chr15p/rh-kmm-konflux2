...
parser.add_argument('-t', '--template', action='store', required=False, default="fbc/hub-catalog-template.json,fbc/op-catalog-template.json", help='comma seperated list of templates to process')
